...
gcsfuse -o allow_other --file-mode=777 --dir-mode=777 --implicit-dirs ${configbucket} /var/www/html/LocalSettingsLink
...
gcsfuse -o allow_other --file-mode=777 --dir-mode=777 --implicit-dirs ${imagebucket} /var/www/html/imagesLink
